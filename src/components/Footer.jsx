  ...
  return (
    <footer className="cureo-footer">
      <div className="footer-content">
        ...
        <div className="footer-col">
          ...
          <ul style={{ padding: 0, margin: 0 }}>
            ...
            <li><Link to="/about" style={{ color: '#DDE1DD' }}>About Dr. Bezboruah</Link></li>
            <li><Link to="/specialties" style={{ color: '#DDE1DD' }}>Clinical Specialties</Link></li>
            <li><Link to="/philosophy" style={{ color: '#DDE1DD' }}>Treatment Philosophy</Link></li>
      ...
      <div className="footer-bottom">
        <p>© {new Date().getFullYear()} Cureo Homeopathy Clinic. All Rights Reserved.</p>
      </div>
    </footer>
  )
}
